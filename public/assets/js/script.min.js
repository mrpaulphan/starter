...
function accountInfo(currentUserRef) {
    currentUserRef.on("value", function(snapshot) {
        ...
        var userEmail = snapshot.val().email, userUsername = snapshot.val().username, userStartWeek = snapshot.val().startWeek, accountSettings = $(".user-info");
...
var auth = function() {
    var loginSubmitButton = $("#loginSubmit"), registerSubmitButton = $("#submitRegister"), forgetPasswordButton = $("#forgetPassword"), emailInput = $("#loginEmail"), passwordInput = $("#loginPassword"), loginForm = $("#loginForm");
    return {
        login: function() {
            loginSubmitButton.click(function(e) {
                var email = emailInput.val(), password = passwordInput.val();
